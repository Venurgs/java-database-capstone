...
public class Prescription {
    ...
    @Id
    private String id; // MongoDB usa Strings para sus IDs
    ...
    @Size(min = 3, max = 20, message = "La dosis debe tener entre 3 y 20 caracteres")
    private String dosage;

    @Size(max = 200, message = "Las notas no pueden exceder los 200 caracteres")
    private String doctorNotes; // Opcional, sin @NotNull
